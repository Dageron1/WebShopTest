...
namespace WebShopWeb.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Upsert(int? id)
        {
            ...
            {
                //update
                //ProductImages как в ApplicationDbContext иммено с таким же регистром
            ...
            if (ModelState.IsValid)
            {
                ...
                if (files != null)
                {
                    ...
                    foreach(IFormFile file in files) 
                    {
                        ...
                        //можно и в самом потоке объединить Path.Combine(finalPath, fileName)
        ...
        {
            IEnumerable<Product> objProductList = _unitOfWork.Product.GetAll(includeProperties: "Category,ProductImages").ToList();
